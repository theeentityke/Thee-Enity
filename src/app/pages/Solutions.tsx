...
const industries: Industry[] = [
  ...
  },
  {
    ...
    solution: "Retail Intelligence Suite",
    problem: "Retailers struggle with inventory management, customer insights, and personalized marketing at scale.",
    ourSolution: "Our retail platform provides real-time inventory tracking, customer behavior analytics, and AI-powered recommendations.",
  ...
  },
  {
    ...
    ourSolution: "We create digital learning environments that enhance student engagement and streamline administrative processes.",
  ...
  },
  {
    ...
    solution: "HealthTech Solutions",
    problem: "Healthcare providers need better tools for patient management, data security, and operational efficiency.",
    ourSolution: "Our healthcare solutions improve patient care coordination while ensuring data security and regulatory compliance.",
  ...
  return (
    <section className="min-h-screen w-full py-20 px-4 relative overflow-hidden" id="solutions">
      ...
      <div className="max-w-6xl mx-auto w-full">
        ...
        {/* Who We Are Section */}
        <div className="border border-purple-400/30 rounded-3xl p-8 mb-16 backdrop-blur-lg bg-white/5">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
              {[
                ...
                <div key={index} className="text-center p-4 rounded-xl bg-white/5 border border-purple-400/20 hover:border-purple-400/40 transition-all duration-300">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-20">
          {solutions.map((solution, index) => (
            <div 
              key={index}
              className="border border-purple-400/30 rounded-2xl p-6 backdrop-blur-lg bg-white/5 hover:bg-white/10 transition-all duration-500 hover:scale-105 cursor-pointer group"
                ...
                <button
                  ...
                  className={`w-full text-left p-5 rounded-xl border transition-all duration-300 ${
                    selectedIndustry.name === industry.name
                      ...
                      : "border-white/20 hover:border-purple-400/40 hover:bg-purple-400/5"
                  }`}
                >
            ...
            <div className="border border-blue-400/30 rounded-2xl p-6 bg-white/5">
              ...
              <div className="space-y-4">
                <div className="bg-white/5 rounded-xl p-4 border border-purple-400/20">
                  <h4 className="text-purple-300 font-bold mb-2 text-sm uppercase tracking-wider">The Problem</h4>
                ...
                <div className="text-center pt-4">
                  <div className="inline-block bg-purple-400/10 border border-purple-400/30 rounded-lg px-4 py-2 mb-4">
                    <span className="text-purple-300 font-semibold">
                      {selectedIndustry.solution}
                    </span>
                  </div>
                  <button className="w-full bg-white text-black font-bold py-3 rounded-xl hover:scale-105 transition-transform duration-300 border border-white hover:border-purple-400">
        ...
        <div className="text-center mt-16">
          <div className="border border-purple-400/30 rounded-3xl p-8 backdrop-blur-lg bg-white/5">
            <h2 className="text-3xl font-bold text-white mb-4">
            ...
            <button className="bg-white text-black font-bold py-3 px-8 rounded-xl hover:scale-105 transition-transform duration-300 border border-white hover:border-purple-400">
          ...
          <div className="border border-purple-400/30 rounded-3xl p-6 backdrop-blur-xl bg-gray-900/95 max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="space-y-6">
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-white/5 rounded-xl p-4 border border-purple-400/20">
                  <h4 className="text-purple-300 font-bold mb-3 text-sm uppercase tracking-wider">The Challenge</h4>
                  <p className="text-white/80 text-sm leading-relaxed">
              ...
              <div className="bg-white/5 rounded-xl p-4 border border-purple-400/20">
                <h4 className="text-purple-300 font-bold mb-3 text-sm uppercase tracking-wider">Key Features</h4>
              ...
              <div className="flex gap-3 pt-4">
                <button className="bg-white text-black font-bold px-6 py-3 rounded-xl hover:scale-105 transition-transform duration-300 flex-1 border border-white hover:border-purple-400">
                  Get This Solution
                </button>
                <button 
                  onClick={() => setSelectedSolution(null)}
                  className="bg-white/10 text-white px-6 py-3 rounded-xl font-semibold hover:bg-white/20 transition-all duration-300 flex-1 border border-white/20 hover:border-purple-400/40"
                >
                  Close
                </button>
              </div>
